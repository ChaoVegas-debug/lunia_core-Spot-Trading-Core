...
export const SystemPage: React.FC = () => {
  ...
  const health = usePolledResource<HealthResponse>((signal) => getHealth(signal, client), 4000, [auth]);
  const status = usePolledResource<StatusSnapshot>((signal) => getStatus(signal, client), 4000, [auth]);
