...
export function getBranding(signal: AbortSignal, client?: ClientOptions) {
  return apiFetch<BrandingConfig>('/branding', { method: 'GET', signal }, client);
}
...
export function createUser(
  body: { email: string; password: string; role: string; tenant_id?: string },
  signal: AbortSignal,
...
export function getTenants(signal: AbortSignal, client?: ClientOptions) {
  return apiFetch<{ items: TenantRecord[] }>('/admin/tenants', { method: 'GET', signal }, client);
}

export function createTenant(body: Partial<TenantRecord>, signal: AbortSignal, client?: ClientOptions) {
  return apiFetch<TenantRecord>('/admin/tenants', { method: 'POST', signal, body: JSON.stringify(body) }, client);
}

export function updateTenant(id: number, body: Partial<TenantRecord>, signal: AbortSignal, client?: ClientOptions) {
  return apiFetch<TenantRecord>(`/admin/tenants/${id}`, { method: 'PUT', signal, body: JSON.stringify(body) }, client);
}

export function getTenantBranding(id: number, signal: AbortSignal, client?: ClientOptions) {
  return apiFetch<TenantBrandingPayload>(`/admin/tenants/${id}/branding`, { method: 'GET', signal }, client);
}

export function updateTenantBranding(id: number, body: TenantBrandingPayload, signal: AbortSignal, client?: ClientOptions) {
  return apiFetch<TenantRecord>(`/admin/tenants/${id}/branding`, { method: 'PUT', signal, body: JSON.stringify(body) }, client);
}

export function updateTenantLimits(id: number, body: TenantLimitsRequest, signal: AbortSignal, client?: ClientOptions) {
  return apiFetch<{ items: LimitEntry[] }>(`/admin/tenants/${id}/limits`, { method: 'PUT', signal, body: JSON.stringify(body) }, client);
}
